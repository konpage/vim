...
"
" d) git repos on your local machine (i.e. when working on your own plugin)
...
"<========= original repo on github OK!


" using the following plugins LIKE a)
Bundle 'taglist.vim'
Bundle 'SuperTab'
Bundle 'vimwiki'
Bundle 'winmanager'
...
" taglist
" desc:  list the tags
" usage: in the taglist window, u(update the tag) [[(the prev file) ]](the
"        next file)
